  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-white">
        ...
        />
        <span className="absolute left-4 top-4 rounded-sm bg-white/95 px-2.5 py-1 text-xs font-bold tracking-wide text-brand-700 shadow-sm ring-1 ring-ink-900/10">
          {product.model}
        </span>
      </div>
